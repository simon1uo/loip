...
const words = [
  ...
  'consequat', 'convallis', 'cras', 'cubilia', 'curabitur', 'curae', 'cursus', 'dapibus', 'diam',
  'dictum', 'dignissim', 'dis', 'dolor', 'donec', 'dui', 'duis', 'efficitur', 'egestas', 'eget',
  ...
  'fusce', 'gravida', 'habitant', 'habitasse', 'hendrerit', 'himenaeos', 'iaculis', 'id',
  ...
  'magnis', 'maecenas', 'malesuada', 'massa', 'mattis', 'mauris', 'maximus', 'metus', 'mi',
  'molestie', 'mollis', 'montes', 'morbi', 'nam', 'nascetur', 'natoque', 'nec', 'neque', 'netus',
  ...
  'sapien', 'scelerisque', 'sed', 'sem', 'semper', 'senectus', 'sit', 'sociosqu', 'sodales',
  'sollicitudin', 'suscipit', 'suspendisse', 'taciti', 'tellus', 'tempor', 'tempus', 'tincidunt',
  'torquent', 'tortor', 'tristique', 'turpis', 'ullamcorper', 'ultrices', 'ultricies', 'urna',
  'ut', 'varius', 'vehicula', 'vel', 'velit', 'venenatis', 'vestibulum', 'vitae', 'vivamus',
...
const usernameAdjectives = [
  'happy', 'smart', 'cool', 'brave', 'clever', 'bright', 'swift', 'quick', 'fast', 'strong',
  'mighty', 'super', 'mega', 'ultra', 'hyper', 'epic', 'awesome', 'amazing', 'brilliant', 'fantastic'
]

const usernameNouns = [
  'cat', 'dog', 'fox', 'wolf', 'tiger', 'lion', 'eagle', 'hawk', 'bear', 'panda',
  'coder', 'dev', 'guru', 'ninja', 'wizard', 'master', 'hero', 'champion', 'star', 'legend'
]
...
export const loremIpsum = (options: LoremIpsumOptions = {}): string[] => {
  const {
    p = 1,
...
export const name = (gender: Gender = 'all'): string => {
  if (gender === 'male') {
...
export const fullname = (gender: Gender = 'all'): string => {
...
export const avatarUrl = (gender: Gender = 'all'): string => {
