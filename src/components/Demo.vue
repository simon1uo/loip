<template>
  <div class="demo-container p-6 max-w-4xl mx-auto">
    <h1 class="text-3xl font-bold mb-6 text-center text-dark">Vue Lorem Ipsum</h1>
    <p class="text-center mb-8">A Vue 3 component for generating placeholder text</p>
    ...
    <div class="output bg-white p-6 rounded-lg shadow mb-8">
      <h2 class="text-xl font-semibold mb-4">Lorem Ipsum Text</h2>
    ...
    <div class="user-info bg-white p-6 rounded-lg shadow mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="user-card p-4 border rounded-lg text-center">
          ...
          <h3 class="text-lg font-medium">{{ fullname('male') }}</h3>
          <p class="text-gray-600">@{{ username() }}</p>
        </div>

        <div class="user-card p-4 border rounded-lg text-center">
          <Avatar gender="female" class="w-24 h-24 mx-auto mb-4" />
          <h3 class="text-lg font-medium">{{ fullname('female') }}</h3>
          <p class="text-gray-600">@{{ username() }}</p>
        </div>
...
&lt;LoremIpsum :p="2" /&gt;
      ...
      <div class="example mb-6">
        <h3 class="text-lg font-medium mb-2">With Options</h3>
        <pre class="bg-gray-100 p-4 rounded overflow-x-auto">
&lt;LoremIpsum 
  :p="3"
...
/&gt;
      ...
      <div class="example">
        <h3 class="text-lg font-medium mb-2">Using Functions</h3>
        <pre class="bg-gray-100 p-4 rounded overflow-x-auto">
